...
import '../helper/widgets/myText.dart';
...
class VideoCallForReceiver extends StatefulWidget {
  final User_model user_model;
   String chanelName;

   VideoCallForReceiver({super.key, required this.user_model, required this.chanelName});

  @override
  State<VideoCallForReceiver> createState() => _VideoCallForReceiverState();
}

class _VideoCallForReceiverState extends State<VideoCallForReceiver> {
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Container(
            width: Get.width,
            child:beforeAcceptReceiverOption(),
          ),
        )
  ...
  Widget beforeAcceptReceiverOption(){
