...
// print(model.sender.id);
  ...
  void initState() {
   ...
   //egisterEvent('new-message',chatController.msgListner);
    //fetchChat();
  }
  ...
  //
  //
  //     scrolList(chatController.scrollController);
  //
  //
  //   }
  //
...
//       }
//
//       chatController.chatList.add(ChatModel(content: contant, mediaType: mediaType, url: url, lati: lati, longi: longi, time: time, sender: widget.receiver, receiver: widget.sender));
//
//
//       setState(() {
//
