...
class CallRepository {
  Future<VoiceCall?> makeCall(
      String token, String receiver, String type) async {
    VoiceCall? user;
    final String url = AppConfig.DIRECTORY +
        (type == VoiceCall.TYPE_AUDIO
            ? "user/startAudioCall"
            : "user/startVidoCall");
  ...
  Future<bool> inviteCallParticipants(
    String token,
    String call_id,
    List<String> ids,
  ) async {
